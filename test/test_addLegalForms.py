...
def test_addLegalForm(app):
    ...
    app.legalForms.edit(wait, "ttrter23sdf")
    app.legalForms.search_for_new_added("ttrter23sdf")
    time.sleep(4)
    app.legalForms.check_if_added()
...
def test_addLegalForm_with_SP_checkbox(app):
    ...
    app.legalForms.edit(wait, "rter23sdf")
    app.legalForms.search_for_new_added("rter23sdf")
    time.sleep(4)
    app.legalForms.check_if_added()
