...
class statusesHelper:
    ...
    def search_for_new_added(self, wait, status_name):
        wait.until(EC.invisibility_of_element((By.CSS_SELECTOR, "form-15--1_popup")))
        search_input = wait.until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, "#grid-15_tab [role=textbox]")))
        search_input.click()
        search_input.clear()
